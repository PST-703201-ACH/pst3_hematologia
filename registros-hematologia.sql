...
\restrict sJXKcy0QzDrHtTiUvqktlM0R7WRcOpx4UBpLLoVdeVSiSj3GC2xznDk01rBFQ8x

-- Dumped from database version 18.4
-- Dumped by pg_dump version 18.4

-- Started on 2026-08-24 14:14:02
...
--
-- TOC entry 5233 (class 0 OID 16418)
-- Dependencies: 226
-- Data for Name: enfermedad; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.enfermedad (enfermedad_id, tipo, descripcion) FROM stdin;
\.


--
-- TOC entry 5235 (class 0 OID 16423)
-- Dependencies: 228
...
--
-- TOC entry 5243 (class 0 OID 16449)
-- Dependencies: 236
-- Data for Name: municipio; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.municipio (municipio_id, estado_id, nombre) FROM stdin;
1	1	Alto Orinoco
2	1	Atabapo
3	1	Atures
4	1	Autana
...
--
-- TOC entry 5250 (class 0 OID 16473)
-- Dependencies: 243
-- Data for Name: parroquia; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.parroquia (parroquia_id, municipio_id, nombre) FROM stdin;
1	1	Alto Orinoco
...
--
-- TOC entry 5253 (class 0 OID 16480)
-- Dependencies: 246
-- Data for Name: persona; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.persona (persona_id, nombres, apellidos, fecha_nacimiento, sexo, cedula, telefono, email, estado_id, municipio_id, parroquia_id, direccion_exacta) FROM stdin;
2	Jeandel Jose	Hernandez Muñoz	2006-07-24	Masculino	V-31491413	04125894503	jeandelhernandez@gmail.com	24	82	1119	Zoologico
3	Gilmar Carolina	Ruiz 	2006-06-24	Femenino	V-20301584	04122955240	gilmaruizcarolina@gmail.com	24	43	1119	Zoologico
4	Angel David	Martinez Ventura	2006-07-24	Masculino	V-31557087	04123605601	Angeldavidmarven@gmail.com	24	356	1118	Mamera
5	Kelvin Alexander	Peña Cova	2006-07-24	Masculino	V-28469291	04241018208	kelvineitor3004@gmail.com	24	43	462	El Silencio
6	Hector Eyeri	Mijares Coronado	2006-06-24	Masculino	V-31186630	04141734273	hector.mijares2025@gmail.com	24	43	1118	La Cumbre
1	Angel David	Granados Carrillo	2006-07-24	Masculino	V-31940105	04241457972	granadoscarrilloangeldavid@gmail.com	24	462	1129	La Sosa
7	jose	muñoz	2017-05-28	Masculino	31491413	04125894503	granadoscarrilloangeldavid@gmail.com	24	462	1119	.asjfdalskjfdasljkdfhaskdjfhaskjdf
8	Angel	Carrillo	2006-02-05	Masculino	5698235	04241457869	granadoscarrilloangeldavid@gmail.com	1	1	1	por ahi njda
9	david	castillo	2006-06-05	Masculino	31564256	12345678	lasadjuntas@gmail.com	1	1	1	por ahi
10	Josue	Garcia	2026-06-08	Masculino	31940105	04241457972	granadoscarrilloangeldavid@gmail.com	1	1	1	por ahi njda
11	Angel David	Granados Carrillo	\N	\N	\N	\N	\N	\N	\N	\N	\N
35	Angel	Garcia	\N	\N	\N	\N	\N	\N	\N	\N	\N
36	Juan	Valdez	\N	\N	\N	\N	\N	\N	\N	\N	\N
\.


--
-- TOC entry 5247 (class 0 OID 16462)
-- Dependencies: 240
-- Data for Name: paciente; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.paciente (paciente_id, persona_id, hc, status) FROM stdin;
1	11	1	0
25	35	2	0
26	36	3	0
\.
...
--
-- TOC entry 5265 (class 0 OID 16518)
-- Dependencies: 258
...
--
-- TOC entry 5269 (class 0 OID 16531)
-- Dependencies: 262
-- Data for Name: tipo_consulta; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tipo_consulta (tipo_id, nombre) FROM stdin;
\.


--
-- TOC entry 5275 (class 0 OID 16548)
-- Dependencies: 268
-- Data for Name: usuario; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.usuario (usuario_id, persona_id, username, password_hash, status, id_rol) FROM stdin;
3	3	20301584	$2y$10$5TT4WAEIiy/XW5bCBSU3muekgfP9Q7hFEE5ct5yBjYWBhAbHTIePq	2	1
4	4	31557087	$2y$10$nUSCIqxOSceaE00d/sK0gOjUt6cQCMAfvM74YsZroJi5Xz3qH/vE6	2	1
5	5	28469291	$2y$10$EHA9cbHtSzy3Uzca3IMXNOuKTHyyin8P8vC2UwvdP0ESKkWYYsDRS	2	1
6	6	31186630	$2y$10$eFSihuDaDZv4AIWqOQ8aXO1sN3QuIPEfqZJge7bPF4oC0b0aIE0CK	2	1
2	2	31491413	$2y$12$4XXGMiBREGdJCBR5Bh71tO/06SQ88vBbSzQeWGYmNFilwrS0EJLEy	1	3
1	1	31940105	$2y$12$lm8QHM.wQ5fak86wj6PP2uqCBaxK.8p.sIrkUBU/B/7mG24f3UTs2	1	2
\.


--
-- TOC entry 5231 (class 0 OID 16410)
-- Dependencies: 224
-- Data for Name: consulta; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.consulta (consulta_id, paciente_id, medico_id, tipo_id, enfermedad_id, fecha_hora, peso, talla, sc, fc, fr, subjetivo, plan_trabajo, proxima_cita, status) FROM stdin;
1	1	\N	\N	\N	2026-07-31 16:01:00	\N	\N	\N	\N	\N	\N	\N	\N	\N
13	25	\N	\N	\N	2026-07-20 03:00:00	\N	\N	\N	\N	\N	\N	\N	\N	0
14	26	\N	\N	\N	2026-07-21 13:00:00	\N	\N	\N	\N	\N	\N	\N	\N	0
\.


--
-- TOC entry 5226 (class 0 OID 16391)
-- Dependencies: 219
-- Data for Name: antecedente_familiar; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.antecedente_familiar (ant_fam_id, paciente_id, consulta_id, parentesco, patologia, descripcion) FROM stdin;
\.


--
-- TOC entry 5228 (class 0 OID 16398)
-- Dependencies: 221
-- Data for Name: auditoria; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.auditoria (auditoria_id, descripcion, modulo, id_usuario, fecha_hora, accion) FROM stdin;
19	Ingreso al listado de usuarios en el sistema	Usuarios	1	2026-08-02 20:02:07	Listado
20	Ingreso al listado de usuarios en el sistema	Usuarios	1	2026-08-02 20:11:21	Listado
\.


--
-- TOC entry 5229 (class 0 OID 16405)
-- Dependencies: 222
-- Data for Name: cita; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cita (cita_id, nombres_paciente, apellidos_paciente, nombres_representante, apellidos_representante, numero_hc, fecha_hora, consulta_id) FROM stdin;
24	Angel David	Granados Carrillo	Ronald Rafael	Granados Yanez	1	2026-07-31 16:01:00	1
32	Angel	Garcia	Jose	Garcia	2	2026-07-20 03:00:00	13
33	Juan	Valdez	Jose	Valdez	3	2026-07-21 13:00:00	14
\.


--
-- TOC entry 5237 (class 0 OID 16429)
-- Dependencies: 230
-- Data for Name: examen; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.examen (examen_id, nombre, unidad_medida, valor_ref_min, valor_ref_max, status) FROM stdin;
\.
...
-- Dependencies: 232
-- Data for Name: frotis_fsp; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.frotis_fsp (fsp_id, consulta_id, seg_val, lin_val, mon_val, eos_val, blastos_val, morfologia, observaciones) FROM stdin;
\.


--
-- TOC entry 5241 (class 0 OID 16442)
-- Dependencies: 234
-- Data for Name: migrations; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.migrations (id, migration, batch) FROM stdin;
1	2026_04_25_231818_create_antecedente_familiar_table	1
2	2026_04_25_231818_create_auditoria_table	1
3	2026_04_25_231818_create_cache_locks_table	1
4	2026_04_25_231818_create_cache_table	1
5	2026_04_25_231818_create_consulta_table	1
6	2026_04_25_231818_create_enfermedad_table	1
7	2026_04_25_231818_create_estado_table	1
8	2026_04_25_231818_create_examen_catalogo_table	1
9	2026_04_25_231818_create_failed_jobs_table	1
10	2026_04_25_231818_create_frotis_fsp_table	1
11	2026_04_25_231818_create_jobs_table	1
12	2026_04_25_231818_create_job_batches_table	1
13	2026_04_25_231818_create_municipio_table	1
14	2026_04_25_231818_create_orden_laboratorio_table	1
15	2026_04_25_231818_create_paciente_representante_table	1
16	2026_04_25_231818_create_paciente_table	1
17	2026_04_25_231818_create_parroquia_table	1
18	2026_04_25_231818_create_password_reset_tokens_table	1
19	2026_04_25_231818_create_permiso_table	1
20	2026_04_25_231818_create_persona_table	1
21	2026_04_25_231818_create_protocolo_ciclo_table	1
22	2026_04_25_231818_create_protocolo_sesion_table	1
23	2026_04_25_231818_create_protocolo_tratamiento_table	1
24	2026_04_25_231818_create_representante_table	1
25	2026_04_25_231818_create_resultado_laboratorio_table	1
26	2026_04_25_231818_create_rol_permiso_table	1
27	2026_04_25_231818_create_rol_table	1
28	2026_04_25_231818_create_sessions_table	1
29	2026_04_25_231818_create_tipaje_sanguineo_table	1
30	2026_04_25_231818_create_tipo_consulta_catalogo_table	1
31	2026_04_25_231818_create_transfusion_table	1
32	2026_04_25_231818_create_unidad_hemocomponente_table	1
33	2026_04_25_231818_create_users_table	1
34	2026_04_25_231818_create_usuario_permiso_table	1
35	2026_04_25_231818_create_usuario_table	1
36	2026_04_25_231821_add_foreign_keys_to_antecedente_familiar_table	1
37	2026_04_25_231821_add_foreign_keys_to_auditoria_table	1
\.


--
-- TOC entry 5245 (class 0 OID 16455)
-- Dependencies: 238
-- Data for Name: orden_laboratorio; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.orden_laboratorio (orden_id, consulta_id, tipo_seguimiento, fecha_solicitud, status) FROM stdin;
\.


--
-- TOC entry 5261 (class 0 OID 16507)
-- Dependencies: 254
-- Data for Name: representante; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.representante (representante_id, persona_id, ocupacion) FROM stdin;
\.


--
-- TOC entry 5249 (class 0 OID 16467)
-- Dependencies: 242
-- Data for Name: paciente_representante; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.paciente_representante (paciente_id, representante_id, parentesco, es_principal) FROM stdin;
\.


--
-- TOC entry 5259 (class 0 OID 16499)
-- Dependencies: 252
-- Data for Name: protocolo_tratamiento; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.protocolo_tratamiento (protocolo_id, paciente_id, consulta_id, nombre, indicaciones, fecha_inicio, estado, usuario_medico_id) FROM stdin;
\.


--
-- TOC entry 5255 (class 0 OID 16487)
-- Dependencies: 248
-- Data for Name: protocolo_ciclo; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.protocolo_ciclo (ciclo_id, protocolo_id, numero_ciclo, fecha_inicio, estado) FROM stdin;
\.


--
-- TOC entry 5257 (class 0 OID 16493)
-- Dependencies: 250
-- Data for Name: protocolo_sesion; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.protocolo_sesion (sesion_id, ciclo_id, fecha_hora, tipo_sesion, status) FROM stdin;
\.


--
-- TOC entry 5263 (class 0 OID 16512)
-- Dependencies: 256
-- Data for Name: resultado_laboratorio; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.resultado_laboratorio (resultado_id, orden_id, examen_id, valor_encontrado, status) FROM stdin;
\.


--
-- TOC entry 5267 (class 0 OID 16523)
-- Dependencies: 260
-- Data for Name: tipaje_sanguineo; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tipaje_sanguineo (tipaje_id, paciente_id, fecha, grupo_ab, factor_rh, fenotipo_extendido, genetica_transfusional, metodo, usuario_registrador_id, status) FROM stdin;
\.


--
-- TOC entry 5273 (class 0 OID 16542)
-- Dependencies: 266
-- Data for Name: unidad_hemocomponente; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.unidad_hemocomponente (unidad_id, codigo_bolsa, tipo_componente, grupo_rh, volumen_ml, fecha_vencimiento, status) FROM stdin;
\.


--
-- TOC entry 5271 (class 0 OID 16536)
-- Dependencies: 264
-- Data for Name: transfusion; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.transfusion (transfusion_id, paciente_id, unidad_id, consulta_id, fecha_hora, volumen_adm, status) FROM stdin;
\.
...
-- Dependencies: 220
-- Name: antecedente_familiar_ant_fam_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.antecedente_familiar_ant_fam_id_seq', 1, false);


--
-- TOC entry 5283 (class 0 OID 0)
-- Dependencies: 223
-- Name: cita_cita_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.cita_cita_id_seq', 33, true);
...
SELECT pg_catalog.setval('public.consulta_consulta_id_seq', 14, true);


--
-- TOC entry 5285 (class 0 OID 0)
-- Dependencies: 227
-- Name: enfermedad_enfermedad_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.enfermedad_enfermedad_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.estado_estado_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.examen_examen_id_seq', 1, false);


--
-- TOC entry 5288 (class 0 OID 0)
-- Dependencies: 233
-- Name: frotis_fsp_fsp_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.frotis_fsp_fsp_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.municipio_municipio_id_seq', 335, true);


--
-- TOC entry 5291 (class 0 OID 0)
-- Dependencies: 239
-- Name: orden_laboratorio_orden_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.orden_laboratorio_orden_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.paciente_paciente_id_seq', 26, true);
...
SELECT pg_catalog.setval('public.parroquia_parroquia_id_seq', 1016, true);


--
-- TOC entry 5294 (class 0 OID 0)
-- Dependencies: 245
-- Name: permiso_permiso_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.permiso_permiso_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.persona_persona_id_seq', 36, true);


--
-- TOC entry 5296 (class 0 OID 0)
-- Dependencies: 249
-- Name: protocolo_ciclo_ciclo_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.protocolo_ciclo_ciclo_id_seq', 1, false);


--
-- TOC entry 5297 (class 0 OID 0)
-- Dependencies: 251
-- Name: protocolo_sesion_sesion_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.protocolo_sesion_sesion_id_seq', 1, false);


--
-- TOC entry 5298 (class 0 OID 0)
-- Dependencies: 253
-- Name: protocolo_tratamiento_protocolo_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.protocolo_tratamiento_protocolo_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.representante_representante_id_seq', 1, false);


--
-- TOC entry 5300 (class 0 OID 0)
-- Dependencies: 257
-- Name: resultado_laboratorio_resultado_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.resultado_laboratorio_resultado_id_seq', 1, false);
...
-- Dependencies: 261
-- Name: tipaje_sanguineo_tipaje_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tipaje_sanguineo_tipaje_id_seq', 1, false);


--
-- TOC entry 5303 (class 0 OID 0)
-- Dependencies: 263
-- Name: tipo_consulta_tipo_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tipo_consulta_tipo_id_seq', 1, false);


--
-- TOC entry 5304 (class 0 OID 0)
-- Dependencies: 265
-- Name: transfusion_transfusion_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.transfusion_transfusion_id_seq', 1, false);


--
-- TOC entry 5305 (class 0 OID 0)
-- Dependencies: 267
-- Name: unidad_hemocomponente_unidad_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.unidad_hemocomponente_unidad_id_seq', 1, false);
...
-- Completed on 2026-08-24 14:14:02

--
-- PostgreSQL database dump complete
--

\unrestrict sJXKcy0QzDrHtTiUvqktlM0R7WRcOpx4UBpLLoVdeVSiSj3GC2xznDk01rBFQ8x
