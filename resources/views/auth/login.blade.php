    ...
    @section('css')
        ...
        <style>
            body.login-page, body.register-page {
                background: url("{{ asset('img/fondo-login.jpeg') }}") no-repeat center center fixed !important;
    ...
    @section('auth_body')
        ...
        <form action="{{ route('login') }}" method="post" id="formLogin">
            ...
            <div class="input-group mb-3">
                <input type="password" name="password" id="clave" class="form-control @error('password') is-invalid @enderror"
                       placeholder="Contraseña">
                <button class="btn btn-secondary fas fa-eye-slash" id="btnClave" type="button"></button>
                    
                
                <div class="input-group mb-3">
                    <button type="button" id="olBtn" class="btn btn-block btn-primary">{{ __('adminlte::adminlte.i_forgot_my_password') }}
                    </button>
                </div>
            </div>
            <div id="alertLogin">
