...
class PersonaRequest extends FormRequest
{
    ...
    {
        $isUpdate = $this->route()->getActionMethod() === 'actualizar'; // detecta si es actualizar
        ...
        return [ // reglas de validacion para los diferentes metodos
            ...
            'correo' => $isUpdate ? 'required|email|unique:persona,email,' . $this->input('persona') . ',persona_id' : 'required|email|unique:persona,email',
